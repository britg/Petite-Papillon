...
@implementation AddRayRayPhotoViewController
...
-(void) showPicker {
	DebugLog(@"Showing picker for Ray Rays");
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
	...
	NSString *pathComponent = [NSString stringWithFormat:@"rayrays/%@.png", [now description]]; 
	...
	// Create thumb image
	NSString *fullPathToThumbImage = [pathToDocuments stringByAppendingPathComponent:[NSString stringWithFormat:@"rayray_thumbs/%@.png",[now description]]];
	...
	CGFloat scaleFactor = 100/sideFull;
